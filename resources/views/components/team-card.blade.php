...
<a href="{{ route('scores.team', strtolower($team->name)) }}"
   class="team-card group block rounded-2xl p-5 border border-white/10 hover:border-white/30 transition-all active:scale-95"
   style="--team-color: {{ $team->color_hex }};">
