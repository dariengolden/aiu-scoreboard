                ...
                @if($sport->description)
                    <div class="relative">
                        <button type="button"
                                ...
                                class="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white transition-colors"
                                aria-label="View rules for {{ $sport->name }}">
                        ...
                        @if($sport->standings_description)
                            <div class="relative">
                                <button type="button"
                                        ...
                                        class="w-6 h-6 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white transition-colors"
