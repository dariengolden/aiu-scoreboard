...
<div class="max-w-5xl mx-auto px-4 py-6">
    ...
    <div class="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
        <a href="{{ route('admin.standings.index') }}" class="hover:text-white transition-colors">Standings</a>
        <span>/</span>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-white/5 text-xs text-slate-400 uppercase tracking-wider">
                        ...
                        <th class="text-center px-2 py-3" title="Goals For"><abbr title="Goals For" class="no-underline cursor-help">GF</abbr></th>
                        <th class="text-center px-2 py-3" title="Goals Against"><abbr title="Goals Against" class="no-underline cursor-help">GA</abbr></th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-white/5 last:border-b-0 {{ $index === 0 && $row['played'] > 0 ? 'bg-yellow-500/5' : '' }}">
                        ...
                        <td class="text-center px-2 py-3 text-slate-300">{{ $row['played'] }}/{{ $totalMatches }}</td>
                        ...
                        <td class="text-center px-2 py-3 text-slate-400">{{ $row['goals_for'] }}</td>
                        <td class="text-center px-2 py-3 text-slate-400">{{ $row['goals_against'] }}</td>
