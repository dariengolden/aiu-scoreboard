...
<div class="max-w-lg">
    ...
    <h1 class="text-2xl font-black text-white mb-6">New User</h1>
    ...
    <div class="bg-[#1e293b] rounded-2xl p-6 border border-white/5">
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-5">
            ...
            <div>
                <label for="password_confirmation" class="block text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">Confirm Password</label>
